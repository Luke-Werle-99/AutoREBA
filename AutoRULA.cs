...
public class AutoRULA : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        int tableB= RULA_Score_OberkörperBeinhaltung(neckS, trunkS, legS);
    ...
    public static int RULA_Score_OberkörperBeinhaltung(int hals, int oberkörper, int beine)
    {
        // Two-dimensional obekörperBeinhaltung_RULAScore_1: 1D = Öberkörper, 2D = Beine
        int[,] obekörperBeinhaltung_RULAScore_1 = new int[6, 2] { { 1, 3 }, { 2, 3 }, { 3, 4 }, { 5, 5 }, { 6, 6 }, { 7, 7 } };

        // Two-dimensional obekörperBeinhaltung_RULAScore_2: 1D = Öberkörper, 2D = Beine
        int[,] obekörperBeinhaltung_RULAScore_2 = new int[6, 2] { { 2, 3 }, { 2, 3 }, { 3, 4 }, { 5, 5 }, { 6, 7 }, { 7, 7 } };

        // Two-dimensional obekörperBeinhaltung_RULAScore_3: 1D = Öberkörper, 2D = Beine
        int[,] obekörperBeinhaltung_RULAScore_3 = new int[6, 2] { { 3, 3 }, { 3, 4 }, { 4, 5 }, { 5, 6 }, { 6, 7 }, { 7, 7 } };

        // Two-dimensional obekörperBeinhaltung_RULAScore_4: 1D = Öberkörper, 2D = Beine
        int[,] obekörperBeinhaltung_RULAScore_4 = new int[6, 2] { { 5, 5 }, { 5, 6 }, { 6, 7 }, { 7, 7 }, { 7, 7 }, { 8, 8 } };

        // Two-dimensional obekörperBeinhaltung_RULAScore_5: 1D = Öberkörper, 2D = Beine
        int[,] obekörperBeinhaltung_RULAScore_5 = new int[6, 2] { { 7, 7 }, { 7, 7 }, { 7, 8 }, { 8, 8 }, { 8, 8 }, { 8, 8 } };

        // Two-dimensional obekörperBeinhaltung_RULAScore_6: 1D = Öberkörper, 2D = Beine
        int[,] obekörperBeinhaltung_RULAScore_6 = new int[6, 2] { { 8, 8 }, { 8, 8 }, { 8, 8 }, { 8, 9 }, { 9, 9 }, { 9, 9 } };
        ...
        if (hals == 1)
        {
            if (oberkörper == 1)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_1[0, 0]; // answer 1
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_1[0, 1]; // answer 3
                }

            }
            else if (oberkörper == 2)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_1[1, 0]; // answer 2
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_1[1, 1]; // answer 3
                }
            }
            else if (oberkörper == 3)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_1[2, 0]; // answer 3
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_1[2, 1]; // answer 4
                }
            }
            else if (oberkörper == 4)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_1[3, 0]; // answer 5
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_1[3, 1]; // answer 5
                }
            }
            else if (oberkörper == 5)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_1[4, 0]; // answer 6
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_1[4, 1]; // answer 6
                }
            }
            else if (oberkörper == 6)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_1[5, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_1[5, 1]; // answer 7
                }
            }
        }
        else if (hals == 2)
        {
            if (oberkörper == 1)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_2[0, 0]; // answer 2
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_2[0, 1]; // answer 3
                }
            ...
            else if (oberkörper == 2)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_2[1, 0]; // answer 2
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_2[1, 1]; // answer 3
                }
            }
            else if (oberkörper == 3)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_2[2, 0]; // answer 4
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_2[2, 1]; // answer 5
                }
            }
            else if (oberkörper == 4)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_2[3, 0]; // answer 5
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_2[3, 1]; // answer 5
                }
            }
            else if (oberkörper == 5)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_2[4, 0]; // answer 6
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_2[4, 1]; // answer 7
                }
            }
            else if (oberkörper == 6)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_2[5, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_2[5, 1]; // answer 7
                }
            }
        }
        else if (hals == 3)
        {
            if (oberkörper == 1)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_3[0, 0]; // answer 3
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_3[0, 1]; // answer 3
                }
            ...
            else if (oberkörper == 2)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_3[1, 0]; // answer 3
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_3[1, 1]; // answer 4
                }
            }
            else if (oberkörper == 3)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_3[2, 0]; // answer 4
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_3[2, 1]; // answer 5
                }
            }
            else if (oberkörper == 4)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_3[3, 0]; // answer 5
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_3[3, 1]; // answer 6
                }
            }
            else if (oberkörper == 5)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_3[4, 0]; // answer 6
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_3[4, 1]; // answer 7
                }
            }
            else if (oberkörper == 6)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_3[5, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_3[5, 1]; // answer 7
                }
            }
        }
        else if (hals == 4)
        {
            if (oberkörper == 1)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_4[0, 0]; // answer 5
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_4[0, 1]; // answer 5
                }
            ...
            else if (oberkörper == 2)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_4[1, 0]; // answer 5
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_4[1, 1]; // answer 6
                }
            }
            else if (oberkörper == 3)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_4[2, 0]; // answer 6
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_4[2, 1]; // answer 7
                }
            }
            else if (oberkörper == 4)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_4[3, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_4[3, 1]; // answer 7
                }
            }
            else if (oberkörper == 5)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_4[4, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_4[4, 1]; // answer 7
                }
            }
            else if (oberkörper == 6)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_4[5, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_4[5, 1]; // answer 8
                }
            }
        }
        else if (hals == 5)
        {
            if (oberkörper == 1)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[0, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[0, 1]; // answer 7
                }
            ...
            else if (oberkörper == 2)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[1, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[1, 1]; // answer 7
                }
            }
            else if (oberkörper == 3)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[2, 0]; // answer 7
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[2, 1]; // answer 8
                }
            }
            else if (oberkörper == 4)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[3, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[3, 1]; // answer 8
                }
            }
            else if (oberkörper == 5)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[4, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[4, 1]; // answer 8
                }
            }
            else if (oberkörper == 6)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[5, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[5, 1]; // answer 8
                }
            }
        }
        else if (hals == 6)
        {
            if (oberkörper == 1)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_5[0, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_5[0, 1]; // answer 8
                }
            ...
            else if (oberkörper == 2)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_6[1, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_6[1, 1]; // answer 8
                }
            }
            else if (oberkörper == 3)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_6[2, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_6[2, 1]; // answer 8
                }
            }
            else if (oberkörper == 4)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_6[3, 0]; // answer 8
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_6[3, 1]; // answer 9
                }
            }
            else if (oberkörper == 5)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_6[4, 0]; // answer 9
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_6[4, 1]; // answer 9
                }
            }
            else if (oberkörper == 6)
            {
                if (beine == 1)
                {
                    return obekörperBeinhaltung_RULAScore_6[5, 0]; // answer 9
                }
                else if (beine == 2)
                {
                    return obekörperBeinhaltung_RULAScore_6[5, 1]; // answer 9
                }
            }
        }
    ...
    public static int RULA_Score_Gesamtpunktzahl(int gesamtwertArmHandgelenk, int gesamtwerkHalsOberkörperBeine)
    {
        ...
        {
            if (gesamtwerkHalsOberkörperBeine == 1)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 1 // Ergebnis: akzeptabel");
                return gesamtwertArmHandgelenk_RULAScore_1[0];
            }
            else if (gesamtwerkHalsOberkörperBeine == 2)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 2 // Ergebnis: akzeptabel");
                return gesamtwertArmHandgelenk_RULAScore_1[1];

            }
            else if (gesamtwerkHalsOberkörperBeine == 3)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 3 // Ergebnis: in naher Zukunft weitere Maßnahmen einleiten");
                return gesamtwertArmHandgelenk_RULAScore_1[2];

            }
            else if (gesamtwerkHalsOberkörperBeine == 4)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 3 // Ergebnis: in naher Zukunft weitere Maßnahmen einleiten");
                return gesamtwertArmHandgelenk_RULAScore_1[3];

            }
            else if (gesamtwerkHalsOberkörperBeine == 5)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 4 // Ergebnis: in naher Zukunft weitere Maßnahmen einleiten");
                return gesamtwertArmHandgelenk_RULAScore_1[4];

            }
            else if (gesamtwerkHalsOberkörperBeine == 6)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 5 // Ergebnis: in Kürze weitere Maßnahmen einleiten");
                return gesamtwertArmHandgelenk_RULAScore_1[5];

            }
            else if (gesamtwerkHalsOberkörperBeine >= 7)
            {
                System.Console.WriteLine("Gesamtpunktzahl: 5 // Ergebnis: in Kürze weitere Maßnahmen einleiten");
        ...
        else if (gesamtwertArmHandgelenk == 3)
        {
            ...
            {
                System.Console.WriteLine("Gesamtpunktzahl: 6 // Ergebnis: in Kürze weitere Maßnahmen einleiten");
        ...
        else if (gesamtwertArmHandgelenk == 5)
        {
            ...
            {
                System.Console.WriteLine("Gesamtpunktzahl: 5 // Ergebnis: in in Kürze weitere Maßnahmen einleiten");
            ...
            {
                System.Console.WriteLine("Gesamtpunktzahl: 7 // Ergebnis: sofort weitere Maßnahmen einleiten");
        ...
        else if (gesamtwertArmHandgelenk == 6)
        {
            ...
            {
                System.Console.WriteLine("Gesamtpunktzahl: 6 // Ergebnis: in in Kürze weitere Maßnahmen einleiten");
